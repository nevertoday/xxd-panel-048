...
المواصفات: [Skill](SKILL.md) · [النص الأصلي](references/048-source.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-048-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-048-prompt.zh-CN.md)

## الموجّه الأصلي هو المرجع الجمالي الوحيد

الملف `references/048-source.md` هو المرجع الإبداعي والجمالي الوحيد للمشروع. لا تلخّص المهارة نصّه ولا توسعه، ولا تفرض لوحة ألوان مشتركة أو «دافعاً جمالياً» أو عنواناً أو حزمة نصوص قصيرة. يتبع GPT Image 2 قواعد الموجّه الأصلي نفسه في اللون والخامة والتكوين والفراغ والنص والطباعة.
